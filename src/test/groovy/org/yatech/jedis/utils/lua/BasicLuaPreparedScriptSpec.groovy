 ...
 */
class BasicLuaPreparedScriptSpec extends Specification {
    ...
    def 'exec - no script caching'() {
        ...
        def prepScript = new BasicLuaPreparedScript('script-text', keys, argv, LuaScriptConfig.newConfig().useScriptCaching(false).build())
    ...
    def 'exec - with script caching'() {
        ...
        def argv = [new LuaStringValueArgument('str1'),
                    ...
                    new LuaIntValueArgument('long1'),
                    new LuaDoubleValueArgument('dbl1')]
        def prepScript = new BasicLuaPreparedScript('script-text', keys, argv, LuaScriptConfig.newConfig().useScriptCaching(true).build())
